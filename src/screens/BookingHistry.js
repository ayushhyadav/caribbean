    ...
    render(){
        return(
            <div>
                <SceensHeader/>
                <div>
                <div style={{display:'flex',width:'90%',marginTop:10}}><div style={{fontSize:20,fontWeight:'600',color:'#0F172A',padding:10,paddingLeft:30,borderBottom:'1px solid #E2E8F0'}}>Bookings</div>
