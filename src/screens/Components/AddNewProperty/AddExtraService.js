...
export default class AddExtraService extends Component {
  render() {
    return (
        <div style={{width:'100%',padding:20}}>
        <label style={{marginLeft:20}}>Step 4/4</label>
...
{/* <label style={{marginTop:10,color:'#474554',width:'55%'}}>Upload Certifcate</label><br/> */}
       ...
       <button style={{width:'10%',borderRadius:10,height:'45px',borderWidth:0,background:'white' }}
         onClick={()=>this.props.NextCallBack({navigationTo:'Extra_Service',id:3,currentid:4,bt_type:'Back'})}
           >Back</button>
                 <Link style={{width:'20%'}}to="/mylisting">   <button style={{width:120, color:'white',background:'#F15A29',borderRadius:10,height:'45px',marginLeft:10 }}>Finish</button></Link>
                    </div>
        </div>
        </div>
